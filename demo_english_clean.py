...
# -*- coding: utf-8 -*-
"""
Clean English Demo for Thermal Insulation Analysis System
Clean Demo for Thermal Insulation Analysis System
"""

from thermal_analyzer_english import ThermalAnalyzer

def run_clean_english_demo():
    """Run clean English demo with new database"""
    print("=== Thermal Insulation Analysis System Demo ===")
    print("Clean English version - No external dependencies required")
    
    # Create analyzer instance with new database
    analyzer = ThermalAnalyzer("thermal_data_english.db")
    
    # 1. Import English HTML files
    print("\n1. Importing English HTML files...")
    analyzer.import_html_files("./html_files_english")
